...
// Microsoft, instead of the current company name, which is Smrf (Social Media
// Research Foundation).  This is done to retain backward compatibility with
// older graph data providers.
...
namespace jakedavies.JakeDataProviderNodeXL
{
    ...
    ///
    /// <remarks>
    /// This implementation of the <see cref="IGraphDataProvider2" /> simulates a
    /// graph data provider that retrieves the friends of a user from some public
    /// API.  The actual public API calls are omitted.
    /// </remarks>
    //*****************************************************************************

    public class JakeDataProviderNodeXL : IGraphDataProvider2
    {
        //*************************************************************************
        //  Property: Name
        //
        ...
        ///
        /// <value>
        /// See the <see cref="IGraphDataProvider2" /> topic for details.
        /// </value>
        //*************************************************************************
        ...
        Description
        {
            get
            {
                return ("show the friends of a user");
            }
        }
